...
short usSpeedGiro = 200; // default motor speed Giro
short magicWheel1 = 1;
short magicWheel2 = 1;
short magicWheel3 = 1;
short magicWheel4 = 1;
...
void robot_left(float angulo)
{
    ...
    usMotor_Status = CW;
    motorGo(MOTOR_1, usMotor_Status, usSpeedGiro+20);
    motorGo(MOTOR_2, usMotor_Status, usSpeedGiro+20);
    usMotor_Status = CCW;
    motorGo(MOTOR_3, usMotor_Status, usSpeedGiro+20);
    motorGo(MOTOR_4, usMotor_Status, usSpeedGiro+20);
    while (tempo > (millis() - tempoInicio))
    {
    }
    // Desliga tudo para não dar açoite quando for andar para frente
